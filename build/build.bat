...
if exist "%ProgramFiles%\Microsoft Visual Studio\2017\Enterprise\Common7\Tools\VsDevCmd.bat" goto detectMsBuildFromVs15Ent
if exist "%ProgramFiles(x86)%\Microsoft Visual Studio\2017\Enterprise\Common7\Tools\VsDevCmd.bat" goto detectMsBuildFromVs15Ent
if exist "%ProgramFiles%\Microsoft Visual Studio\2017\Professional\Common7\Tools\VsDevCmd.bat" goto detectMsBuildFromVs15Prof
if exist "%ProgramFiles(x86)%\Microsoft Visual Studio\2017\Professional\Common7\Tools\VsDevCmd.bat" goto detectMsBuildFromVs15Prof
...
:detectMsBuildFromVs15Prof
echo VS2017-Professional detected. Loading Env-Settings for VS2017.
...
:detectMsBuildFromVs15Ent
echo VS2017-Enterprise detected. Loading Env-Settings for VS2017.
if exist "%ProgramFiles%\Microsoft Visual Studio\2017\Enterprise\Common7\Tools\VsDevCmd.bat" (
